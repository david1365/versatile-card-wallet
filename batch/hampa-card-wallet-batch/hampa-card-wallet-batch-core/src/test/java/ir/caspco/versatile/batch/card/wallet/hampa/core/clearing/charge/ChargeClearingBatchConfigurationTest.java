...
@ContextConfiguration(classes = {
        ChargeClearingBatchConfiguration.class,
        TestChargeJobConfiguration.class,
        ChargeClearingItemReader.class,
        ClearingItemProcessor.class,
        ChargeClearingItemWriter.class,
        ClearingUtil.class,
...
class ChargeClearingBatchConfigurationTest {
